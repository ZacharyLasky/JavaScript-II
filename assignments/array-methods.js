...
// on their behalf for some much needed updates to their facilities.  Each business has assigned a representative to attend the event along with a small donation.
...
// Problem 2
let smallDonations = runners.filter(donate => donate.donation < 50);

// Problem 3
let longLastName = runners.filter(name => name.last_name.length > 7);